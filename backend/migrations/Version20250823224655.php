 ...
 */
final class Version20250823224655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscriptions ALTER amount SET NOT NULL');
        $this->addSql('ALTER TABLE subscriptions ALTER total_paid SET DEFAULT \'0.00\'');
        $this->addSql('ALTER TABLE subscriptions ALTER total_paid SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscriptions ALTER service_id TYPE UUID');
        $this->addSql('ALTER TABLE subscriptions ALTER user_id TYPE UUID');
        $this->addSql('ALTER TABLE subscriptions ALTER amount DROP NOT NULL');
        $this->addSql('ALTER TABLE subscriptions ALTER total_paid DROP DEFAULT');
        $this->addSql('ALTER TABLE subscriptions ALTER total_paid DROP NOT NULL');
